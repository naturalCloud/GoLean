...
-- ----------------------------
BEGIN;
INSERT INTO `categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `created_at`, `updated_at`) VALUES (1, NULL, 1, 4, 0, '数据库', '2018-06-02 10:49:46', '2018-06-02 11:18:11');
INSERT INTO `categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `created_at`, `updated_at`) VALUES (2, NULL, 5, 8, 0, '后端', '2018-06-02 10:50:09', '2018-06-02 11:18:11');
INSERT INTO `categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `created_at`, `updated_at`) VALUES (3, 2, 6, 7, 1, 'php', '2018-06-02 11:14:29', '2018-06-02 11:18:11');
INSERT INTO `categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `created_at`, `updated_at`) VALUES (4, NULL, 9, 10, 0, 'linux', '2018-06-02 11:17:26', '2018-06-02 11:18:11');
INSERT INTO `categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `created_at`, `updated_at`) VALUES (5, 1, 2, 3, 1, 'mysql', '2018-06-02 11:18:11', '2018-06-02 11:18:11');
COMMIT;
...
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2017_12_23_085521_add_users_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2017_12_28_111756_create_article_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2017_12_30_142122_create_categories_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2017_12_31_143011_create_tags_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_03_121356_add_html_content_to_articles_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_04_021159_create_article_tags_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_05_062957_create_navigations_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_09_144849_create_systems_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_10_031610_create_link_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_01_10_035756_create_pages_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_03_22_152609_create_comments_table', 1);
INSERT INTO `migrations` (`migration`, `batch`) VALUES ('2018_05_25_093803_add_list_pic_to_articles_table', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `navigations` (`id`, `name`, `url`, `state`, `sequence`, `nav_type`, `article_cate_id`, `created_at`, `updated_at`) VALUES (1, 'php', 'http://mynewblog.cn/category/3', 0, 0, 1, 3, '2018-06-02 11:47:34', '2018-06-02 11:47:34');
INSERT INTO `navigations` (`id`, `name`, `url`, `state`, `sequence`, `nav_type`, `article_cate_id`, `created_at`, `updated_at`) VALUES (2, '后端', 'http://mynewblog.cn/category/2', 0, 0, 1, 2, '2018-06-02 11:47:47', '2018-06-02 11:47:47');
INSERT INTO `navigations` (`id`, `name`, `url`, `state`, `sequence`, `nav_type`, `article_cate_id`, `created_at`, `updated_at`) VALUES (3, '数据库', 'http://mynewblog.cn/category/1', 0, 0, 1, 1, '2018-06-02 11:47:50', '2018-06-02 11:47:50');
INSERT INTO `navigations` (`id`, `name`, `url`, `state`, `sequence`, `nav_type`, `article_cate_id`, `created_at`, `updated_at`) VALUES (5, '时间线', 'http://mynewblog.cn/article/select', 0, 0, 0, 0, '2018-06-02 12:04:22', '2018-06-02 12:04:22');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (1, 'blog_name', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (2, 'motto', '天空任鸟飞');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (3, 'title', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (4, 'seo_keyword', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (5, 'seo_desc', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (6, 'github_url', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (7, 'qq', '');
INSERT INTO `systems` (`id`, `key`, `value`) VALUES (8, 'comment_plugin', 'changyan');
...
-- ----------------------------
BEGIN;
INSERT INTO `tags` (`id`, `tag_name`, `created_at`, `updated_at`) VALUES (1, 'mysql', '2018-06-02 11:23:47', '2018-06-02 11:23:47');
COMMIT;
