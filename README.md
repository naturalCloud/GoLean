...
1. [变量定义](variable/variable.go)
2. [变量类型](dataType/dataType.go)
3. [常量](constant/constant.go)
4. [流程控制和循环](branchLoop/branchLoop.go)
5. [函数](function/function.go)
6. [指针](point/pointer.go)
7. [数组](array/array.go)
8. [切片](slices/slices.go)
9. [映射](maps/maps.go)
10. [字符](rune/rune.go)
11. [结构体](struct/struct.go)
12. [封装](tree/tree.go)
